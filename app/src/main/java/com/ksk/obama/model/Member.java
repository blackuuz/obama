...
public class Member implements Parcelable{
     ...
     * c_Car : 5607
     * c_Add :
     * c_Password : c81e728d9d4c2f636f067f89cc14862c
     * c_BirthdayType :
     * i_BirthdayYear : 2000
     * i_BirthdayMonth : 1
     * i_BirthdayDay : 1
     ...
     * n_AmountAvailable : 943167.42
     * n_IntegralAvailable : 222326.98
     * n_IntegralAccumulated : 241257.82
     * t_CreateTime : 2016-08-22 10:52:11.000
     * t_StopTime : 2026-08-21 00:00:00.000
     * t_LastTime : 2016-09-08 17:28:28.670
     * c_OpenID :
     * c_Remark :
     * c_Photo :
     * c_Memberpath : 0
    ...
    protected Member(Parcel in) {
        ...
        n_IntegralValue = in.readFloat();
        n_DiscountValue = in.readFloat();
        n_AmountAvailable = in.readFloat();
        n_IntegralAvailable = in.readFloat();
        n_IntegralAccumulated = in.readFloat();
        ...
        c_Memberpath = in.readString();
        i_Parent = in.readString();
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeFloat(n_IntegralValue);
        dest.writeFloat(n_DiscountValue);
        dest.writeFloat(n_AmountAvailable);
        dest.writeFloat(n_IntegralAvailable);
        dest.writeFloat(n_IntegralAccumulated);
        ...
        dest.writeString(c_Memberpath);
        dest.writeString(i_Parent);
