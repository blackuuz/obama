...
public class OpenCardStatisticsAdapter extends BaseAdapter {
    private Context context;
    private List<OPenCardStatistics.ResultDataBean> list;
    private LayoutInflater inflater;

    public OpenCardStatisticsAdapter(Context context, List<OPenCardStatistics.ResultDataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        OPenCardStatistics.ResultDataBean info = list.get(position);
        if (convertView == null) {
