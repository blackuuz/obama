...
public class CountStatisticsAdapter extends BaseAdapter {
    private Context context;
    private List<CountStatistics.ResultDataBean> list;
    private LayoutInflater inflater;

    public CountStatisticsAdapter(Context context, List<CountStatistics.ResultDataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        CountStatistics.ResultDataBean info = list.get(position);
        if (convertView == null) {
        ...
        holder.tv_chongzhi.setText(info.getGoods() + "");//应收
        holder.tv_shishou.setText(info.getTimes() + "");//实收
        return convertView;
    }
