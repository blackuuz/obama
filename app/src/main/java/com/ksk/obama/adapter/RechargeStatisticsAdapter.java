...
public class RechargeStatisticsAdapter extends BaseAdapter {

    private Context context;
    private List<RechargeStatistics.ResultDataBean> list;
    private LayoutInflater inflater;

    public RechargeStatisticsAdapter(Context context, List<RechargeStatistics.ResultDataBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        RechargeStatistics.ResultDataBean info = list.get(position);
        if (convertView == null) {
