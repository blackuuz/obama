...
import com.ksk.obama.adapter.RechargeStatisticsAdapter;
import com.ksk.obama.callback.IHttpCallBack;
import com.ksk.obama.model.RechargeStatistics;
...
public class RechargeStatisticsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<RechargeStatistics.ResultDataBean> list = new ArrayList<>();
    private RechargeStatisticsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                intent.setClass(RechargeStatisticsActivity.this,RechargeStatisticsDetialsActivity.class);
    ...
    private void getHttpData() {
        ...
        map.put("UserinfoId", SharedUtil.getSharedData(RechargeStatisticsActivity.this, "userInfoId"));
        map.put("dbName", SharedUtil.getSharedData(RechargeStatisticsActivity.this, "dbname"));
    ...
    private void showHttpData(String jsonText) {
        RechargeStatistics statistics = new Gson().fromJson(jsonText, RechargeStatistics.class);
        if (statistics.getResult_stadus().equals("SUCCESS")) {
            ...
            if (list != null && list.size() > 0) {
                adapter = new RechargeStatisticsAdapter(RechargeStatisticsActivity.this, list);
                lv_data.setAdapter(adapter);
            } else {
                Utils.showToast(RechargeStatisticsActivity.this,"此条件下没有数据");
            }
        } else {
            Utils.showToast(RechargeStatisticsActivity.this, statistics.getResult_errmsg());
        }
    }
