...
public class BuyCountstatisticsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_countstatistics);
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                intent.setClass(BuyCountstatisticsActivity.this,BuyCountStatisticsDetialsActivity.class);
    ...
    private void getHttpData() {
        ...
        map.put("UserinfoId", SharedUtil.getSharedData(BuyCountstatisticsActivity.this, "userInfoId"));
        map.put("dbName", SharedUtil.getSharedData(BuyCountstatisticsActivity.this, "dbname"));
    ...
    private void showHttpData(String jsonText) {
        ...
        if (statistics.getResult_stadus().equals("SUCCESS")) {
            ...
            if (list != null && list.size() > 0) {
                adapter = new BuyCountStatisticsAdapter(BuyCountstatisticsActivity.this, list);
                lv_data.setAdapter(adapter);
            } else {
                Utils.showToast(BuyCountstatisticsActivity.this, "此条件下没有数据");
            }
        } else {
            Utils.showToast(BuyCountstatisticsActivity.this, statistics.getResult_errmsg());
        }
    }
