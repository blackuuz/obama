...
import com.ksk.obama.adapter.ExitCardStatisticsAdapter;
...
public class ExitCardStatisticsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<ExitCardStatistics.ResultDataBean> list = new ArrayList<>();
    private ExitCardStatisticsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exit_card_statistics);
        initView();
        initcalendar();
        getHttpData();
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                intent.setClass(ExitCardStatisticsActivity.this, ExitCardStatisticsDetialsActivity.class);
    ...
    private void initView() {
        ...
        tv_title11.setText("姓名");
        tv_title12.setText("退款金额");
    ...
    private void getHttpData() {
        ...
        map.put("UserinfoId", SharedUtil.getSharedData(ExitCardStatisticsActivity.this, "userInfoId"));
        map.put("dbName", SharedUtil.getSharedData(ExitCardStatisticsActivity.this, "dbname"));
    ...
    private void showHttpData(String jsonText) {
        ExitCardStatistics statistics = new Gson().fromJson(jsonText, ExitCardStatistics.class);
        if (statistics.getResult_stadus().equals("SUCCESS")) {
            tv_title0.setText(statistics.getResult_count() + "条记录");
            tv_title2.setText("退款" + (statistics.getResult_sumPayActual()) + "元");
            tv_title1.setText("");
            list = statistics.getResult_data();
            if (list != null && list.size() > 0) {
                adapter = new ExitCardStatisticsAdapter(ExitCardStatisticsActivity.this, list);
                lv_data.setAdapter(adapter);
            } else {
                Utils.showToast(ExitCardStatisticsActivity.this, "此条件下没有数据");
            }
        } else {
            Utils.showToast(ExitCardStatisticsActivity.this, statistics.getResult_errmsg());
        }
    }
