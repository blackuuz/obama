...
import com.ksk.obama.adapter.OpenCardStatisticsAdapter;
import com.ksk.obama.callback.IHttpCallBack;
import com.ksk.obama.model.OPenCardStatistics;
...
public class OpenCardStatisticsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<OPenCardStatistics.ResultDataBean> list = new ArrayList<>();
    private OpenCardStatisticsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_open_card_statistics);
        initView();
        initcalendar();
        getHttpData();
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                intentb.putExtra("MemberId", list.get(position).getId());
                intentb.setClass(OpenCardStatisticsActivity.this,OpenCardStatisticsDetialsActivity.class);
    ...
    private void getHttpData() {
        ...
        map.put("UserinfoId", SharedUtil.getSharedData(OpenCardStatisticsActivity.this, "userInfoId"));
        map.put("dbName", SharedUtil.getSharedData(OpenCardStatisticsActivity.this, "dbname"));
        ...
        postToHttp(NetworkUrl.USERECORD, map, new IHttpCallBack() {
            ...
            public void OnSucess(String jsonText) {
                Logger.d(jsonText);
                OPenCardStatistics statistics = new Gson().fromJson(jsonText, OPenCardStatistics.class);
                if (statistics.getResult_stadus().equals("SUCCESS")) {
                    ...
                    adapter = new OpenCardStatisticsAdapter(OpenCardStatisticsActivity.this, list);
                    lv_data.setAdapter(adapter);
                } else {
                    Utils.showToast(OpenCardStatisticsActivity.this,statistics.getResult_errmsg());
                }
