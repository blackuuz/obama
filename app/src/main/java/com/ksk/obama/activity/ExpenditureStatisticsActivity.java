...
import com.ksk.obama.adapter.BuyCountStatisticsAdapter;
...
public class ExpenditureStatisticsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<BuyCountStatistics.ResultDataBean> list = new ArrayList<>();
    private BuyCountStatisticsAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_data.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                String type = list.get(position).getC_BillType();
                intent.putExtra("type", type);
                if (type.equals("消费收银")) {
                    intent.setClass(ExpenditureStatisticsActivity.this, ExpenditureStatisticsDetialsActivity.class);
                } else if (type.equals("快速消费")) {
                    intent.setClass(ExpenditureStatisticsActivity.this, ExpenditureQuickStatisticsDetialsActivity.class);
                }
    ...
    private void initView() {
        ...
        tv_title11.setText("应收");
        tv_title12.setText("实收");
    ...
    private void getHttpData() {
        ...
        map.put("BillType", "快速消费,消费收银");
        map.put("UserinfoId", SharedUtil.getSharedData(ExpenditureStatisticsActivity.this, "userInfoId"));
        map.put("dbName", SharedUtil.getSharedData(ExpenditureStatisticsActivity.this, "dbname"));
    ...
    private void showHttpData(String jsonText) {
        BuyCountStatistics statistics = new Gson().fromJson(jsonText, BuyCountStatistics.class);
        if (statistics.getResult_stadus().equals("SUCCESS")) {
            ...
            if (list != null && list.size() > 0) {
                adapter = new BuyCountStatisticsAdapter(ExpenditureStatisticsActivity.this, list);
                lv_data.setAdapter(adapter);
            } else {
                Utils.showToast(ExpenditureStatisticsActivity.this, "此条件下没有数据");
            }
        } else {
            Utils.showToast(ExpenditureStatisticsActivity.this, statistics.getResult_errmsg());
        }
    }
